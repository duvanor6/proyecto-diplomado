...
onMounted(() => {
    ...
    axios.get('https://www.datos.gov.co/resource/r86y-229a.json')
        .then(function (response) {
            ...
            llenarSelect("selectProgramas", programasUnicos);
            const facultadesUnicas = obtenerValoresUnicos(datos.value, "facultad");
            llenarSelect("selectFacultades", facultadesUnicas);
...
<template>
    <BreadCrumb modulo="Datos" accion="Datos por Facultad" />
    ...
    <div class="my-2 text-gray-700">
        ...
        <div class="flex justify-end ">
            ...
            <select @change="filtrarDatos()" id="selectFacultades" class="m-3 w-24 text-black" v-model="facultad">
                <option disabled value="">Facultades</option>
            </select>  
            <select @change="filtrarDatos()" id="selectProgramas" class="m-3 w-24 text-black" v-model="programa">
                <option class="text-black" disabled value="">Programas Acedemicos</option>
            </select>  
